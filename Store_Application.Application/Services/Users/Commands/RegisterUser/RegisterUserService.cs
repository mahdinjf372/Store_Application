...
namespace Store_Application.Application.Services.Users.Commands.RegisterUser
{
    public class RegisterUserService : IRegisterUserService
    {
        ...
        public RegisterUserService(IDataBaseContext db, ISendActivationLinkEmailService sendActivationLinkEmailService)
        {
            _db = db;
            _sendActivationLinkEmailService = sendActivationLinkEmailService;
        }
        public ResultDto Execute(RequestRegisterUserDto req)
        {
            int err = 0;
            try
            {
