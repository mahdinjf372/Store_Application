...
namespace Store_Application.Persistence.Migrations
{
    ...
    [Migration("20210901120343_init-MainSlider-tbl")]
    partial class initMainSlidertbl
    {
            ...
            modelBuilder.Entity("Store_Application.Domain.Entities.Product.Brand", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InsertTime = new DateTime(2021, 9, 1, 16, 33, 42, 13, DateTimeKind.Local).AddTicks(4949),
                            Title = "بدون برند",
                            isRemoved = false
                        });
                });
            ...
            modelBuilder.Entity("Store_Application.Domain.Entities.Product.Slider", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InsertTime = new DateTime(2021, 9, 1, 16, 33, 42, 19, DateTimeKind.Local).AddTicks(9888),
                        ...
                        {
                            Id = 2,
                            InsertTime = new DateTime(2021, 9, 1, 16, 33, 42, 20, DateTimeKind.Local).AddTicks(29),
                            Title = "دوربین",
                            isRemoved = false
                        },
                        new
                        {
                            Id = 3,
                            InsertTime = new DateTime(2021, 9, 1, 16, 33, 42, 20, DateTimeKind.Local).AddTicks(40),
                            Title = "موبایل",
                            isRemoved = false
                        },
                        new
                        {
                            Id = 4,
                            InsertTime = new DateTime(2021, 9, 1, 16, 33, 42, 20, DateTimeKind.Local).AddTicks(45),
                            Title = "لپ تاپ",
                            isRemoved = false
                        });
                });
