...
namespace Store_Application.Persistence.Migrations
{
    ...
    [Migration("20210909093022_init-cart_CartItem_order_orderItem_RequestPay-tbl")]
    partial class initcart_CartItem_order_orderItem_RequestPaytbl
    {
            ...
            modelBuilder.Entity("Store_Application.Domain.Entities.Product.Brand", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InsertTime = new DateTime(2021, 9, 9, 14, 0, 21, 117, DateTimeKind.Local).AddTicks(9619),
                            Title = "بدون برند",
                            isRemoved = false
                        });
                });
            ...
            modelBuilder.Entity("Store_Application.Domain.Entities.Product.Slider", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InsertTime = new DateTime(2021, 9, 9, 14, 0, 21, 123, DateTimeKind.Local).AddTicks(7819),
                        ...
                        {
                            Id = 2,
                            InsertTime = new DateTime(2021, 9, 9, 14, 0, 21, 123, DateTimeKind.Local).AddTicks(7918),
                            Title = "دوربین",
                            isRemoved = false
                        },
                        new
                        {
                            Id = 3,
                            InsertTime = new DateTime(2021, 9, 9, 14, 0, 21, 123, DateTimeKind.Local).AddTicks(7930),
                            Title = "موبایل",
                            isRemoved = false
                        },
                        new
                        {
                            Id = 4,
                            InsertTime = new DateTime(2021, 9, 9, 14, 0, 21, 123, DateTimeKind.Local).AddTicks(7934),
                            Title = "لپ تاپ",
                            isRemoved = false
                        });
                });
