...
namespace EndPoint.WebSite.Models.Comment.LikeComment
{
    public class LikeCommentViewModelValidator : AbstractValidator<LikeCommentViewModel>
    {
        private readonly IProductFacad _productFacad;
        private readonly ICommentFacad _commentFacad;

        public LikeCommentViewModelValidator(IProductFacad productFacad, ICommentFacad commentFacad)
        {
